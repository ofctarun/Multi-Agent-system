 ...
 * @description Reads the content of all files requestedin the query parameter 'files' and returns their content in a JSON response.
...
app.patch("/update-files", async (req, res) => {
    ...
    if (!updates || !Array.isArray(updates)) {
        return res.status(400).json({
            message: 'Invalid request body. Expected a JSON array of updates.',
            status: 'error'
        });
    }
