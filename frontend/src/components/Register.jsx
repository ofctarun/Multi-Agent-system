...
export default function Register() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // The backend /api/auth/register redirects to /auth/callback?token=... on success
            ...
            <div className="relative z-10 w-full max-w-[420px] px-6 animate-fadeIn">
                ...
                <div className="flex flex-col items-center mb-8 text-center">
                    ...
                    <p className="text-sm" style={{ color: '#64748b' }}>
                        Sign up to start spinning up isolated environments
                    </p>
                </div>
                ...
                <p className="text-center text-xs mt-6" style={{ color: '#475569' }}>
                    ...
                    <Link to="/login" className="font-semibold transition-colors" style={{ color: '#22d3ee' }} onMouseEnter={e => e.currentTarget.style.color = '#0891b2'} onMouseLeave={e => e.currentTarget.style.color = '#22d3ee'}>
                        Sign In
                    </Link>
                </p>
            </div>
